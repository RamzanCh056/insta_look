...
class AddSecondRow extends StatefulWidget {
  const AddSecondRow({ Key? key }) : super(key: key);

  @override
  _AddSecondRowState createState() => _AddSecondRowState();
}

class _AddSecondRowState extends State<AddSecondRow> {
  @override
             ...
             mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  //  color: Colors.white,
                    ...
                    onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>  thirdRow  ()));// signup
                    },
                    shape: RoundedRectangleBorder(
                      side: BorderSide(
                        color: Colors.black,
